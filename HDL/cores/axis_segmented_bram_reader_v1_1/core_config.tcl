set display_name {AXI4-Stream Segmented Block RAM Reader}
...
ipx::add_bus_parameter PHASE $bus
...
#set sim_script [glob -nocomplain cores/axis_segmented_bram_reader_v1_0/sim_config.tcl]
#if {[llength $sim_script] > 0 && $simulate_core == "TRUE" } {
#    source $sim_script
#    if [expr {[get_value -radix dec /testbench_top/error_count] > 0}] {
#        error "Core Failed to Pass Simulation"
#    }
#}

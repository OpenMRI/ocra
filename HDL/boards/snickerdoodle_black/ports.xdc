...
### JB1.11 (IO_L6P_T0_34)
set_property PACKAGE_PIN    P14         [get_ports {gpio2_tri_io[12]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio2_tri_io[12]}]

### JB1.12 (IO_L4N_T0_34)
set_property PACKAGE_PIN    W13         [get_ports {gpio2_tri_io[15]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio2_tri_io[15]}]

### JB1.13 (IO_L6N_T0_VREF_34)
set_property PACKAGE_PIN    R14         [get_ports {gpio2_tri_io[13]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio2_tri_io[13]}]

### JB1.14 (IO_L4P_T0_34)
set_property PACKAGE_PIN    V12         [get_ports {gpio2_tri_io[14]}]
...
### JB1.29 (IO_L8P_T1_34)
set_property PACKAGE_PIN    W14         [get_ports {gpio2_tri_io[2]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio2_tri_io[2]}]

### JB1.30 (IO_L10N_T1_34)
set_property PACKAGE_PIN    W15         [get_ports {gpio2_tri_io[5]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio2_tri_io[5]}]

### JB1.31 (IO_L8N_T1_34)
set_property PACKAGE_PIN    Y14         [get_ports {gpio2_tri_io[3]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio2_tri_io[3]}]
...
set_property PACKAGE_PIN    U14         [get_ports {gpio2_tri_io[6]}]
...
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio4_tri_io[8]}]

### JC1.6 (IO_L12N_T1_MRCC_13)
set_property PACKAGE_PIN    U10         [get_ports {gpio4_tri_io[11]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio4_tri_io[11]}]

### JC1.7 (IO_L11N_T1_SRCC_13)
set_property PACKAGE_PIN    V7          [get_ports {gpio4_tri_io[9]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio4_tri_io[9]}]

### JC1.8 (IO_L12P_T1_MRCC_13)
set_property PACKAGE_PIN    T9          [get_ports {gpio4_tri_io[10]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio4_tri_io[10]}]

### JC1.11 (IO_L19P_T3_13)
set_property PACKAGE_PIN    T5          [get_ports {gpio4_tri_io[12]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio4_tri_io[12]}]

### JC1.12 (IO_L20N_T3_13)
set_property PACKAGE_PIN    Y13         [get_ports {gpio4_tri_io[15]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio4_tri_io[15]}]

### JC1.13 (IO_L19N_T3_VREF_13)
set_property PACKAGE_PIN    U5          [get_ports {gpio4_tri_io[13]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio4_tri_io[13]}]

### JC1.14 (IO_L20P_T3_13)
set_property PACKAGE_PIN    Y12         [get_ports {gpio4_tri_io[14]}]
...
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio4_tri_io[0]}]

### JC1.29 (IO_L17P_T2_13)
set_property PACKAGE_PIN    U9          [get_ports {gpio4_tri_io[2]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio4_tri_io[2]}]

### JC1.30 (IO_L16N_T2_13)
set_property PACKAGE_PIN    W9          [get_ports {gpio4_tri_io[5]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio4_tri_io[5]}]

### JC1.31 (IO_L17N_T2_13)
set_property PACKAGE_PIN    U8          [get_ports {gpio4_tri_io[3]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio4_tri_io[3]}]

### JC1.32 (IO_L16P_T2_13)
set_property PACKAGE_PIN    W10         [get_ports {gpio4_tri_io[4]}]
set_property IOSTANDARD     LVCMOS33    [get_ports {gpio4_tri_io[4]}]

### JC1.35 (IO_L14P_T2_SRCC_13)
set_property PACKAGE_PIN    Y9          [get_ports {gpio4_tri_io[6]}]

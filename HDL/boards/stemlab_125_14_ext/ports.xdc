...
set_property IOSTANDARD LVCMOS33 [get_ports {exp_p_tri_io_*}]
set_property IOSTANDARD LVCMOS33 [get_ports {exp_n_tri_io_*}]
set_property SLEW FAST           [get_ports {exp_p_tri_io_*}]
set_property SLEW FAST           [get_ports {exp_n_tri_io_*}]
set_property DRIVE 8             [get_ports {exp_p_tri_io_*}]
set_property DRIVE 8             [get_ports {exp_n_tri_io_*}]
set_property PULLTYPE PULLUP     [get_ports {exp_p_tri_io_*}]
set_property PULLTYPE PULLUP     [get_ports {exp_n_tri_io_*}]

set_property PACKAGE_PIN G17     [get_ports {exp_p_tri_io_0}]
set_property PACKAGE_PIN G18     [get_ports {exp_n_tri_io_0}]
set_property PACKAGE_PIN H16     [get_ports {exp_p_tri_io_1}]
set_property PACKAGE_PIN H17     [get_ports {exp_n_tri_io_1}]
set_property PACKAGE_PIN J18     [get_ports {exp_p_tri_io_2}]
set_property PACKAGE_PIN H18     [get_ports {exp_n_tri_io_2}]
set_property PACKAGE_PIN K17     [get_ports {exp_p_tri_io_3}]
set_property PACKAGE_PIN K18     [get_ports {exp_n_tri_io_3}]
set_property PACKAGE_PIN L14     [get_ports {exp_p_tri_io_4}]
set_property PACKAGE_PIN L15     [get_ports {exp_n_tri_io_4}]
set_property PACKAGE_PIN L16     [get_ports {exp_p_tri_io_5}]
set_property PACKAGE_PIN L17     [get_ports {exp_n_tri_io_5}]
set_property PACKAGE_PIN K16     [get_ports {exp_p_tri_io_6}]
set_property PACKAGE_PIN J16     [get_ports {exp_n_tri_io_6}]
set_property PACKAGE_PIN M14     [get_ports {exp_p_tri_io_7}]
set_property PACKAGE_PIN M15     [get_ports {exp_n_tri_io_7}]

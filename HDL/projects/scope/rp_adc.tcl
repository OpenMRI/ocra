...
if { $board_name == "stemlab_125_14_4in"} {
    ...
    connect_bd_net [get_bd_pins adc_1_clk] [get_bd_pins adc_clk]
    ...
    connect_bd_net [get_bd_pins adc_1_resetn] [get_bd_pins reset_0/peripheral_aresetn]
    # Create axis_red_pitaya_adc
    cell open-mri:user:axis_red_pitaya_adc_2ch:1.0 adc_0 {} {
        aclk adc_clk

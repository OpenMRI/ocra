...
class MRI_SD_Widget(QDialog):
    ...
    def __init__(self,parent=None):
        ...
        self.AddColumnBtn.move(1300,173)
    ...
    def tableWidget_set(self):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(50,100,1200,723))
